...
func (ds *ChromecastMongoStore) SaveCurrentlyPlaying(ctx context.Context, cp storage.CurrentlyPlaying) error {
	if ds == nil {
...
func (ds *ChromecastMongoStore) GetCurrentlyPlaying(ctx context.Context) ([]storage.CurrentlyPlaying, error) {
	if ds == nil {
	...
	var playing []storage.CurrentlyPlaying
